...
$shipping .= '<p style="font-weight:600;font-size:20px;line-height:1.2em;">Delivery / Pickup: <br>' . $delivery_date . '</p>';
	}
	return $shipping;
}
add_filter( 'wc_pip_document_shipping_method', 'sv_wc_pip_add_order_delivery_shipping', 10, 99999999999 );
?>
